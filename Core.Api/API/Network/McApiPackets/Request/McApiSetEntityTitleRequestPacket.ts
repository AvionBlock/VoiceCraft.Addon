...
export class McApiSetEntityTitleRequestPacket implements IMcApiPacket {
  ...
  public Set(token: string = "", id: number = 0, value: string = ""): McApiSetEntityTitleRequestPacket {
    this._token = token;
    this._id = id;
    this._value = value;
    return this;
